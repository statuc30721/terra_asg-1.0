...
resource "aws_launch_template" "app1_LT" {
    ...
    # This calls a shell script to perform the same tasks
    # as listed below. Uncomment if you want to use the entry-script.sh
    # but you also will need to remove or comment out the user_data = basencode 
    # below.
